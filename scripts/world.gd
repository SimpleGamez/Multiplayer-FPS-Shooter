...
func _on_host_button_pressed() -> void:
	if $Menu/MainMenu/MarginContainer/VBoxContainer/name.text != "" :
		Global.player_name = $Menu/MainMenu/MarginContainer/VBoxContainer/name.text
	else :
		Global.player_name = "GUEST" + str(randi_range(10,99))
	Global.kill_count = 0
	main_menu.hide()
